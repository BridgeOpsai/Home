...
import { BotIcon as Robot, Clock, DollarSign, Shield, Zap, Layers, Code, Cpu } from "lucide-react"

export default function RPAPage() {
  const pageData = {
    title: "RPA (Robotic Process Automation)",
    description: "Transform Business Efficiency with Digital Workers",
    heroDescription:
      "Deploy software robots to automate repetitive, rule-based tasks and free your human workforce for higher-value activities.",
    overview:
      "Robotic Process Automation (RPA) uses software robots to automate routine business processes by mimicking the way humans interact with applications through the user interface. These digital workers can perform data entry, extract information from documents, move files, fill forms, and process transactions with perfect accuracy and consistency. BridgeOps.ai specializes in implementing RPA solutions that deliver rapid ROI by reducing manual effort, eliminating errors, and accelerating process execution.",
    ...
    features: [
      {
        ...
        description:
          "We analyze your operations to identify processes that are ideal candidates for RPA based on volume, complexity, and ROI potential.",
        icon: <Layers className="h-6 w-6" />,
      },
      {
    ...
    ctaDescription: "Schedule a consultation to discuss how RPA can transform your business operations.",
  }
