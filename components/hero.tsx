          ...
          <div className="px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                ...
                <span className="block text-blue-600">With AI-Powered Automation</span>
              </h1>
              <p className="mt-3 text-base text-gray-700 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0 bg-white/70 backdrop-blur-sm p-2 rounded-lg">
                The future is here. AI Agents powered by BridgeOps.ai transform your repetitive tasks from marketing to
                sales with just a simple conversation.
              </p>
              <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                ...
                <div className="mt-3 sm:mt-0 sm:ml-3">
                  <Link href="/book-call">
                    <Button
                      variant="outline"
                      className="w-full flex items-center justify-center px-8 py-3 text-base font-medium rounded-md text-blue-600 border-blue-600 hover:bg-blue-50 md:py-4 md:text-lg md:px-10"
                    >
